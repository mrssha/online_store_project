    ...
    <div class="row">
        ...
        <div class="col-md-3 text-center">
            ...
            <div class="my-3 py-3">
                ...
                <button id = "addRemoveId" type="button" class="btn btn-outline-danger btn-lg"
                        onclick="addRemoveProduct('${contextPath}/addRemoveProduct', '${requestScope.productDetail.id}', id)"
